...
export default function NotFoundContent() {
  ...
  return (
    <div className="mx-auto flex max-w-screen-2xl flex-col items-center gap-4 sm:gap-6 xl:gap-12">
      <h1 className="3xl:text-7xl text-center font-serif text-3xl font-bold tracking-wider sm:text-5xl lg:text-5xl xl:text-6xl">
      ...
      <div className="3xl:text-3xl flex flex-wrap items-center justify-center gap-2 text-sm font-medium sm:text-lg md:gap-6 md:text-base lg:text-lg xl:text-xl 2xl:text-2xl">
