    ...
    <>
      <main className="text-lighter md:px-col-inner relative flex aspect-[1/1.6] w-full px-8 text-center md:aspect-[1/0.52] md:items-center md:text-start">
        ...
        <Image
          ...
          sizes="100vw"
        />
        <div className="3xl:gap-20 mx-auto flex max-w-screen-2xl grow flex-col items-center gap-8 pt-12 md:items-start md:pt-0 xl:gap-12 2xl:gap-16">
          <h1 className="3xl:text-9xl font-serif text-4xl font-semibold tracking-wider sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
            Yogesh Samsi
          </h1>
          <div className="3xl:space-y-12 3xl:text-3xl space-y-6 text-sm font-medium sm:text-lg md:text-base lg:text-lg xl:text-xl 2xl:space-y-8 2xl:text-2xl">
            <div className="flex flex-wrap items-center gap-2 md:gap-6">
              <Button asChild variant="primary" theme="light">
                <Link href="/academy">
                  <span>Learn tabla</span>
                  <span>
                    <ArrowRightIcon className="3xl:w-8 aspect-square w-4 stroke-[2.5px] sm:w-5 xl:w-6" />
                  </span>
                </Link>
              </Button>
              <Button asChild variant="secondary" theme="light">
                <Link href="/#contact">
                  <span>Reach out</span>
                  <span>
                    <ChatBubbleLeftRightIcon className="3xl:w-8 aspect-square w-4 stroke-[2.5px] sm:w-5 xl:w-6" />
                  </span>
                </Link>
              </Button>
            </div>
            <p className="text-light">
              ...
              <Link
                href="/about"
                className="hover:text-lighter underline underline-offset-2 transition-colors"
              >
                Download Biodata
              </Link>
            </p>
      ...
      <Section bgClr="bg-lighter" txtClr="text-darker">
        ...
        <div className="mx-auto grid max-w-lg gap-6 lg:max-w-none lg:grid-cols-3 lg:gap-8 2xl:gap-12">
          {aboutCards.map(({ title, description }, i) => (
            <div key={i} className="border-darker space-y-4 border p-4">
      ...
      <Section id="events" bgClr="bg-dark" txtClr="text-lighter">
        ...
        <div className="mx-auto max-w-lg lg:max-w-none">
          {events.length > 0 ? (
            <div className="3xl:gap-x-20 3xl:gap-y-16 grid gap-x-12 gap-y-8 lg:grid-cols-2 xl:gap-x-16 xl:gap-y-12">
              {events.map((event, i) => (
      ...
      <Section bgClr="bg-lighter" txtClr="text-lighter">
        {testimonials.map(({ name, logo, quote }, i) => (
          <div
            key={i}
            className="bg-dark shadow-dark/50 mx-auto mt-10 w-full max-w-lg px-12 shadow-lg lg:mt-12 lg:max-w-none"
          >
            <div className="flex -translate-y-10 flex-col items-center gap-4 lg:-translate-y-12 xl:gap-6">
              ...
              <div className="mb-6 flex w-full max-w-3xl items-center gap-8 xl:gap-16 2xl:max-w-5xl">
                <div className="text-light hidden aspect-square h-28 lg:block 2xl:h-36">
                  <svg
                ...
                <div className="bg-lighter hidden h-36 w-1 lg:block 2xl:h-44" />
